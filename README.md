...
- **Описание интересов** — свободный текст (до 1000 символов) в отдельной таблице `UserPreferences` (1:1 с `User`, ADR-014), задел под будущую фильтрацию по категориям и AI-оценку релевантности; редактируется на веб-странице `/sources`
